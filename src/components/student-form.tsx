            ...
            <fieldset>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                     <div className="grid items-center gap-1.5">
                        ...
                        <Input id="schedule-instrument" defaultValue={student?.schedule?.instrumento} placeholder="Ex: Seg, Qua 16:00-17:00" />
                    </div>
                     <div className="grid items-center gap-1.5">
                        <Label htmlFor="schedule-ensemble">Classe de Conjunto</Label>
                        <Input id="schedule-ensemble" defaultValue={student?.schedule?.classeDeConjunto} placeholder="Ex: Sex 18:00-19:30" />
                    </div>
                     <div className="grid items-center gap-1.5">
                        <Label htmlFor="schedule-theory">Formação Musical</Label>
                        <Input id="schedule-theory" defaultValue={student?.schedule?.formacaoMusical} placeholder="Ex: Ter 15:00-16:00" />
                    </div>
                     <div className="grid items-center gap-1.5">
                        <Label htmlFor="schedule-other">Outras Disciplinas</Label>
                        <Input id="schedule-other" defaultValue={student?.schedule?.outrasDisciplinas} placeholder="Ex: Coro, Orquestra" />
                    </div>
                </div>
            </fieldset>
